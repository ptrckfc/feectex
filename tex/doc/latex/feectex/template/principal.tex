...
\usepackage[T1]{fontenc}    % Imprime (output) caracteres acentuados.
\usepackage[utf8]{inputenc} % Permite o uso (input) de caracteres acentuados.
...
% Qual data foi / será realizada a defesa?
\diadefesa{XX}
\mesdefesa{janeiro}
\anodefesa{20XX}
